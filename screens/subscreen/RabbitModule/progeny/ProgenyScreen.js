...
const ProgenyScreen = () => {
  ...
  const handleSaveProgeny = async () => {
    ...
    if (!authToken) {
      ...
      const response = await fetch(`${API_BASE_URL}/api/progeny/add-progeny`, {
        method: 'POST',
        headers: {
      ...
      console.log('Progeny added successfully:', data);

      navigation.navigate("Rabbit")
    ...
    // Clear the form by updating state variables
      ...
      console.error('Error saving progeny:', error.message);
  ...
  >
    <View style={styles.container}>
      <View style={styles.greenCard}>
        ...
        <Text style={styles.headerTitle}>Add Progeny</Text>
      </View>
      ...
      <TextInput
        ...
        <TextInput
          ...
          style={styles.input}
          value={parentTagID}
          placeholder="Parent Tag ID"
          onChangeText={text => setParentTagID(text)}
        />
      ...
      {/* Appearance */}
        ...
        { loading ? (
          ...
          <TouchableOpacity onPress={handleSaveProgeny} style={styles.saveButton}>

...
const BreedScreen = () => {
  ...
  const handleSaveBreed = async () => {
    ...
    if (!authToken) {
      ...
      const response = await fetch(`${API_BASE_URL}/api/breed/add-breed`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',        
          'Authorization': `Bearer ${authToken}`,
        },
        body: JSON.stringify({ animalType, breedName }),
      });
      ...
      console.log('Breed added successfully:', data);

      navigation.navigate("RabbitBreed")
    ...
    // Clear the form by updating state variables
      ...
      console.error('Error saving breed:', error.message);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        { loading ? (
          ...
          <TouchableOpacity onPress={handleSaveBreed} style={styles.saveButton}>

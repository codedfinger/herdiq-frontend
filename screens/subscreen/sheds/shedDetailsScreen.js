...
const ShedDetailsScreen = ({ route }) => {
  ...
  const fetchShedAnimals = async () => {
    try {
      ...
      const response = await fetch(`${baseURLDev}/api/shed/get-shed/${shed._id}`, {
        method: 'GET',
        headers: {
  ...
  const handleAddAnimal = async () => {
    try {
      ...
      const response = await fetch(`${baseURLDev}/api/shed/add-shed-animal/${shed._id}`, {
        method: 'PUT',
        headers: {
  ...
  const handleRemoveAnimal = async (tagID) => {
    try {
        ...
        const response = await fetch(`${baseURLDev}/api/shed/remove-shed-animal/${shed._id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${authToken}`,

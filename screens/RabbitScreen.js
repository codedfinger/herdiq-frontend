...
const RabbitScreen = () => {
  ...
  const iconsData = [
    ...
    { name: 'goat', type: 'MaterialIcon', label: 'RabbitAnimals', title: 'Animals' },
    { name: 'pets', type: 'MaterialIcon', label: 'RabbitBreed', title: 'Breed' },
    { name: 'house-siding', type: 'MaterialIcon', label: 'RabbitShed', title: 'Shed' },
    { name: 'local-hospital', type: 'MaterialIcon', label: 'RabbitVaccine', title: 'Vaccine' },
    { name: 'dna', type: 'MaterialCommunityIcon', label: 'RabbitProgeny', title: 'Progeny' },
    { name: 'gender-male-female', type: 'MaterialCommunityIcon', label: 'RabbitBreeding', title: 'Breedig' },
    { name: 'loyalty', type: 'MaterialIcon', label: 'Tags', title: 'Tags' },
    { name: 'baby-bottle', type: 'MaterialCommunityIcon', label: 'RabbitMilk', title: 'Milk' },
  ...
  return (
    <View style={styles.container}>
      <View style={styles.greenCard}>
        ...
        <Text style={styles.headerTitle}>Rabbit</Text>

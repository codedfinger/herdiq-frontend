...
const PigScreen = () => {
  ...
  const iconsData = [
    ...
    { name: 'goat', type: 'MaterialIcon', label: 'PigAnimals', title: 'Animals' },
    { name: 'pets', type: 'MaterialIcon', label: 'PigBreed', title: 'breed' },
    { name: 'house-siding', type: 'MaterialIcon', label: 'PigShed', title: 'Shed' },
    { name: 'local-hospital', type: 'MaterialIcon', label: 'PigVaccine', title: 'Vaccine' },
    { name: 'dna', type: 'MaterialCommunityIcon', label: 'PigProgeny', title: 'Progeny' },
    { name: 'gender-male-female', type: 'MaterialCommunityIcon', label: 'PigBreeding', title: 'Breeding' },
    { name: 'loyalty', type: 'MaterialIcon', label: 'Tags', title: 'Tags' },
    { name: 'baby-bottle', type: 'MaterialCommunityIcon', label: 'PigMilk', title: 'Milk' },
